...
<script type="text/javascript" src="js/jquery.functions_objsw7.js"></script>
<script type="text/javascript" src="js/jquery.functions_mrks.js"></script>
<script type="text/javascript" src="js/jquery.functions_inits7.js"></script>
<script type="text/javascript" src="js/jquery.functions_clicks.js"></script>
...
<input style="width:190px;" type="text" id="placeID" placeholder="<? echo $name_ln[22]; ?>" vertical-align="bottom" name="inputPlace">
</div>
</td>
</tr>
</table>
...
<a class="email" href="registration/?o=new"><? echo $name_ln[13]; ?></a>
</div>
<?
if ($first_name == "") {
?>
...
?>
<div style="width:100%;" class="log clear"><? echo $first_name; ?> &nbsp;<a href="registration/?o=logout"><? echo $name_ln[45]; ?></a></div>
<?
}
?>
</div>

<div class="search-wrap" style="width:270px;">
<div class="search">
...
if ($status_filtr!="") {
    ...
    if ($date_get!="") { echo "<div class=\"time\"><a href=\"?date=no\"><U>".$daysago."</U></a></div>"; }
    if ($uname_get!="") { echo "<div><a href=\"?uname=no\"><U>".$uname_get."</U></a></div>"; }
    if ($loc_get!="") { echo "<div class=\"location\"><a href=\"?loc=no\"><U>".$loc_get."</U></a></div>"; }
    echo "</div>";
}
?>
</div>
...
<div id="personaladd-tab" style="display:none; margin:20px;">
...
<input style="width:425px;" type="text" id="titleID" placeholder="<? echo $name_ln[54]; ?>" vertical-align="bottom" name="inputTitle">
</div>
</td>
</tr>
</table>
...
<table width="450px"  cellspacing="5">
<tr><td>
<?
$curtype=$name_tag[1][3];
for ($i = 1; $i <= $itag; $i++) {
...
<table width="200px"  cellspacing="5">
<tr><td>
<? echo $name_ln[47]; ?>
</td>
<td>
<div class="search" id="titleIDsum0">
<input style="width:70px;" maxlength="5" type="text" id="sumID" placeholder="summ" vertical-align="bottom" name="inputSum">
</div>
</td></tr>
<tr><td>
<? echo $name_ln[48]; ?>
...
<input style="width:390px;" type="text" id="addrID" placeholder="<? echo $name_ln[22]; ?>" vertical-align="center" name="inputPlace">
</div>
</td>
</tr>
</table>
...
<div id="add_map" style="width: 450px; height: 270px; display: none;">
</div>
...
<img src="<? if ($img_get!="") { echo $img_get; } else { echo "images/blanc_new.png"; } ?>" alt="descr1" id="bigimg" width="320px">
</td>
<td valign="top">
						<div id="smallimg">
						</div>
...
<td>
    ...
    <table>
        ...
        <td>
						<ul class="social">
<iframe HEIGHT="60" id="preview-frame" src="social.php" name="preview-frame" frameborder="0" noresize="noresize" SCROLLING="NO"></iframe>
						</ul>
        </td>
        </tr>
        <tr>
...
<textarea style="width: 450px;" name="comment" id="text_add" class="content" placeholder="<? echo $name_ln[55]; ?>" cols="10" rows="10">
<?
echo $text;
?>
</textarea>
...
<a href="#" data-tab-selector="#tab_save" id="btnsave"><? echo $name_ln[32]; ?></a>
</td></tr>
</table>
</div>
					</div>
...
<div>
<textarea style="width: 400px;" name="commadd" id="comm_add" class="content" placeholder="" cols="10" rows="5"></textarea>
	<div class="clear">
	</div>
	<div class="tabs3" id="btncommid">
	<a href="#" data-tab-selector="#tab_comm" id="btncomm">add</a>
	</div>
</div>
