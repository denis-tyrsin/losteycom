...
<link rel="stylesheet" type="text/css" href="css/style66.css"/><!-- media="screen, projection" -->
<script type="text/javascript" src="js/jquery.js"></script>
<script type="text/javascript" src="js/jquery.isotope.js"></script>
<script type="text/javascript" src="js/jquery.sticky.js"></script>
<script type="text/javascript" src="js/jquery.functions_pr.js"></script>
<script type="text/javascript" src="js/jquery.functions_objsw11.js"></script>
...
<div class="layer_auth" style="<? if ($mob_get=="1") { echo "display: none;"; } ?>">
...
<table width="<? if ($mob_get!="1") { echo "450px"; } else { echo "270px"; } ?>">
<tr>
<td width="40px">
...
<iframe HEIGHT="60" id="preview-frame" src="social.php" name="preview-frame" frameborder="0" noresize="noresize" SCROLLING="NO"></iframe>
        ...
        <tr>
        <td width="<? if ($mob_get!="1") { echo "450px"; } else { echo "195px"; } ?>">
						<p>
<span id="text_adddiv">
</span>
<textarea style="width: <? if ($mob_get!="1") { echo "450px"; } else { echo "195px"; } ?>;" name="comment" id="text_add" class="content" placeholder="<? echo $name_ln[55]; ?>" cols="10" rows="10">
<?
echo $text;
?>
</textarea>
